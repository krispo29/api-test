...
func (r repository) CreateHsCode(ctx context.Context, data *CreateHsCodeModel) (string, error) {
	...
	_, err := db.QueryOneContext(ctx, &uuid,
		...
		RETURNING uuid
	`,
		utils.NewNullString(data.GoodsEN),
		utils.NewNullString(data.GoodsTH),
		utils.NewNullString(data.HsCode),
		utils.NewNullString(data.Tariff),
		utils.NewNullString(data.Stat),
		utils.NewNullString(data.UnitCode),
		data.DutyRate,
		utils.NewNullString(data.Remark),
		data.AirServiceCharge,
		data.SeaServiceCharge,
		data.FobPriceControl,
		utils.NewNullString(data.FobPriceControlOriginCurrencyCode),
		utils.NewNullString(data.FobPriceControlOriginCountryCode),
		data.WeightControl,
		utils.NewNullString(data.WeightControlUnitCode),
		data.CifControl,
		utils.NewNullString(data.CifControlDestinationCurrencyCode),
		utils.NewNullString(data.CifControlDestinationCountryCode),
	)
